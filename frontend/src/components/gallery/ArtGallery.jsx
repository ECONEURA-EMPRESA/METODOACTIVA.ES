...
const galleryItems = [
    { src: '/gallery1.png', title: 'Armonía Interior', artist: 'Aurora Del Río' },
    { src: '/gallery2.png', title: 'Despertar Neuroestético', artist: 'Aurora Del Río' },
    { src: '/gallery3.png', title: 'Ritmo Vital', artist: 'Aurora Del Río' },
    { src: '/gallery4.png', title: 'Conexión Profunda', artist: 'Aurora Del Río' },
    { src: '/gallery5.png', title: 'Belleza Sanadora', artist: 'Aurora Del Río' },
    { src: '/gallery6.png', title: 'Equilibrio Vital', artist: 'Aurora Del Río' },
];
